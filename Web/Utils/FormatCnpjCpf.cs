...
public static class FormatCnpjCpf
{
    ...
    public static string Format(string CnpjCpf)
    {
        switch (CnpjCpf.Length)
        {
            case 11: return FormatCPF(CnpjCpf);
            case 14: return FormatCNPJ(CnpjCpf);
            default: return CnpjCpf;
        }
    }
    ...
    public static string RemoveFormat(string Code)
    {
